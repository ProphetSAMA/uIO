...
const fetchRoomInfo = async (userId) => {
  try {
    const response = await axios.get(`http://117.72.10.41:8080/api/users/profile?userId=${userId}`);
...
const fetchRechargeData = async () => {
  try {
    const response = await axios.get('http://117.72.10.41:8080/api/all-power');
...
const fetchData = async () => {
  try {
    const response = await axios.get('http://117.72.10.41:8080/api/recent-week-power');
